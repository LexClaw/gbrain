...
| "quarq search", "hypothesis expansion", "memory type filter", "retrieval constraints" | `gbrain query --quarq` or `gbrain query --hypothesis`. See `docs/memory-types.md` and `docs/concepts/memory-architecture/` |
