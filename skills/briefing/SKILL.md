...
**Interactive vs Autonomous Context:**
- Interactive: Follow full 6-phase workflow below
- Autonomous (cron): Follow streamlined pattern in `references/cron-briefing-pattern.md`
