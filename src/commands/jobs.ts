    ...
    case 'supervisor': {
      ...
      if (isStatusCmd) {
        ...
        if (jsonMode) {
          ...
          console.log(`  Crashes (24h):     ${summary.total} (runtime=${summary.by_cause.runtime_error} oom=${summary.by_cause.oom_or_external_kill} sigpipe=${summary.by_cause.sigpipe} rss=${summary.by_cause.rss_watchdog} unknown=${summary.by_cause.unknown} legacy=${summary.by_cause.legacy})`);
